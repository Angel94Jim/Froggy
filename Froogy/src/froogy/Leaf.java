...
public class Leaf {
    //atributos
    private String leaf; // ---> ayuda hacer el movimiento imagen = string campobits
    ...
    public Leaf(){
        ...
        x=-1300; //posicion inicial
        y=350; //posicion inicial //valores positivos son hacia abajo
        leaf="leaf1.png"; //crga imagen del sapo que se encuentra dentro del paquete
        
        
        ImageIcon img = new ImageIcon(this.getClass().getResource(leaf));//recurso a utilizar, y traer recurso el que esta en frog
