...
public class car2{
    ...
    public car2(){
        ...
        y=80; //posicion inicial //valores positivos son hacia abajo menor cantidad + arriba
        car="carr.png"; //crga imagen del sapo que se encuentra dentro del paquete
    ...
    public void keyPressed(KeyEvent e){
        ...
        if(Key == KeyEvent.VK_UP){
            dx=4; //movimiento derecha en eje x
        }
